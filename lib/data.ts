...
export const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      ...
      "Designed and own the shared campaign tracker those workflows write into — now the single source of truth for campaign spend and delivery status, used day to day by the marketing team, interns, accounting and sales",
