...
export const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      ...
      "Built six AI agent workflows across Supermetrics, Lark Base, Trello and Google Slides that reconcile campaign data between the ad platforms and the team tracker, forecast media estimates from historical performance, and draft report summaries — taking repeated manual data entry out of the reporting cycle",
